  ...
  function getMostLikedBooks() {
    ...
    sort.on("click", function() {
      ...
      $.ajax({
        ...
        $(".mtitle").text("");
        $(".ltitle").html(
          "Popular books<a href='/books'><span class='sort' style='float: right; font-size:1rem;vertical-align:text-bottom;font-weight: normal;padding-top:8px;'>Go back</span></a>"
        );
        result = res["sorted"];
        for (var i = 0; i < result.length; i++) {
          sortData(result[i]);
